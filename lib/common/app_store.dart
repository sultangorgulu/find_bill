...
import 'package:find_bill/register/models/user_model.dart';
import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:firebase_auth/firebase_auth.dart';

class AppStore {
  static final AppStore _apiService = AppStore._internal();
  ...
  Future<dynamic> uploadBill({required num total, required String cid}) async {
    try {
      await _firestore.collection("billingHistory").doc(cid).set({
